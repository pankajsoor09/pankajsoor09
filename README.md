...
A comprehensive user management system with role-based access control (RBAC) for admin and user roles.

**Tech Stack:** Node.js, Express.js, React, MongoDB Atlas, JWT
...
**Frontend Developer Intern** | Enterprise Minds Pvt. Ltd. | Jan 2025 - Present
